...
name: spreadsheets
description: |
  Create spreadsheets, inspect sheet structure, and read or update cell ranges in Google Sheets through Shift's Skill Router.
metadata:
  author: shift
  version: "1.0"
---
...
Use this skill to create a spreadsheet, inspect its structure, read a range, append rows, update cell values, or share a spreadsheet.
